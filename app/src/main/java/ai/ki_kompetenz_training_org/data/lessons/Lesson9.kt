        ...
        sections = listOf(
            ...
            LessonSection(
                ...
                blocks = listOf(
                    ...
                    ContentBlock.TrueFalse(
                        statementDe = "In Phase 2 (Vision) werden Ziele und KPIs definiert.",
                        statementEn = "In phase 2 (vision) goals and KPIs are defined.",
                        isTrue = true,
                        explanationDe = "Richtig — erst Analyse, dann Vision mit messbaren Zielen.",
                        explanationEn = "Correct — first assessment, then vision with measurable goals.",
                    ),
                    ContentBlock.Quiz(
                        questionDe = "Was ist Phase 1 jeder KI-Strategie?",
                        questionEn = "What is phase 1 of every AI strategy?",
                        options = listOf(
                            QuizOption("Assessment: Ist-Zustand analysieren", "Assessment: analyze the status quo", isCorrect = true), QuizOption("Tools kaufen", "Buy tools", isCorrect = false), QuizOption("Personal abbauen", "Cut staff", isCorrect = false), QuizOption("Marketing starten", "Start marketing", isCorrect = false),
                        ),
                        explanationDe = "Richtig! Ohne Assessment fehlt die Basis.",
                        explanationEn = "Correct! Without assessment there is no foundation.",
                    ),
                    ContentBlock.FillBlank(
                        sentenceDe = "In Phase 3 werden Use Cases ausgewaehlt, die den groessten ___ bringen.",
                        sentenceEn = "In phase 3 use cases are selected that deliver the greatest ___.",
                        blankKey = "L9-phase3",
                        choices = listOf("Wert", "Lärm", "Aufwand", "Strom"),
                        correctIndex = 0,
                        explanationDe = "Der Wert entscheidet — nicht die Technik.",
                        explanationEn = "Value decides — not technology.",
                    ),
                ),
            ),
        ),
