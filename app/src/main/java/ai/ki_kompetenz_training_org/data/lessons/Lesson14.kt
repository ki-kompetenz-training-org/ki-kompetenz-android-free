            ...
            LessonSection(
                ...
                blocks = listOf(
                    ...
                    ContentBlock.FillBlank(
                        sentenceDe = "KI-Rechenzentren verbrauchen heute 1-2% des weltweiten ___.",
                        sentenceEn = "AI data centers today consume 1-2% of global ___.",
                        blankKey = "L14-energy",
                        choices = listOf("Stroms", "Wassers", "Oels", "Papiers"),
                        correctIndex = 0,
                        explanationDe = "Richtig — und die Prognose fuer 2030 liegt bei 4%.",
                        explanationEn = "Correct — and the 2030 forecast is 4%.",
                    ),
                    ContentBlock.Quiz(
                        questionDe = "Wie hoch ist die Prognose fuer den Stromanteil der KI-Rechenzentren 2030?",
                        questionEn = "What is the forecast for AI data centers' electricity share in 2030?",
                        options = listOf(
                            QuizOption("4%", "4%", isCorrect = true), QuizOption("2%", "2%", isCorrect = false), QuizOption("8%", "8%", isCorrect = false), QuizOption("12%", "12%", isCorrect = false),
                        ),
                        explanationDe = "Richtig — 4% nach aktueller Prognose.",
                        explanationEn = "Correct — 4% per current forecasts.",
                    ),
                ),
            ),
        ),
