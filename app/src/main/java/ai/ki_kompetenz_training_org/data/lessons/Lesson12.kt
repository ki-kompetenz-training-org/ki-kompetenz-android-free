        ...
        sections = listOf(
            ...
            LessonSection(
                ...
                blocks = listOf(
                    ...
                    ContentBlock.TrueFalse(
                        statementDe = "In einer etablierten KI-Kultur sind Fehler Lernchancen statt Bloessen.",
                        statementEn = "In an established AI culture, mistakes are learning opportunities rather than embarrassments.",
                        isTrue = true,
                        explanationDe = "Richtig — Experimentierfreude braucht Fehlerfreundlichkeit.",
                        explanationEn = "Correct — experimentation requires psychological safety.",
                    ),
                    ContentBlock.KnowledgeCheck(
                        questionDe = "Nenne die 5 Strategien fuer eine erfolgreiche KI-Einfuehrung.",
                        questionEn = "Name the 5 strategies for successful AI adoption.",
                        answerDe = "1. Fruh einbinden, 2. Transparenz, 3. Schulung, 4. Quick Wins sichtbar machen, 5. Vorbilder: Fuehrungskraefte nutzen KI aktiv.",
                        answerEn = "1. Involve early, 2. Transparency, 3. Training, 4. Make quick wins visible, 5. Role models: leaders actively use AI.",
                    ),
                ),
            ),
        ),
